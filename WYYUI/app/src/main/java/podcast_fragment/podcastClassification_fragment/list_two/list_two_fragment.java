package podcast_fragment.podcastClassification_fragment.list_two;
...
public class list_two_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.podcast_class_two, container, false);
