package podcast_fragment.podcastClassification_fragment.list_three;
...
public class list_three_fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.podcast_class_three, container, false);
